...
public abstract class AbstractJavaCodegen extends DefaultCodegen implements CodegenConfig,
    ...
    @Getter
    protected ENUM_PROPERTY_NAMING_TYPE enumPropertyNaming = ENUM_PROPERTY_NAMING_TYPE.MACRO_CASE;
    ...
    /**
     * useBeanValidation has been moved from child generators to
     * AbstractJavaCodegen.
    ...
    public AbstractJavaCodegen() {
        ...
        cliOptions.add(
                new CliOption(CodegenConstants.SCM_DEVELOPER_CONNECTION, CodegenConstants.SCM_DEVELOPER_CONNECTION_DESC)
                        .defaultValue(this.getScmDeveloperConnection()));
        cliOptions.add(
                new CliOption(CodegenConstants.SCM_URL, CodegenConstants.SCM_URL_DESC).defaultValue(this.getScmUrl()));
        ...
        cliOptions.add(new CliOption(CodegenConstants.DEVELOPER_ORGANIZATION_URL,
                CodegenConstants.DEVELOPER_ORGANIZATION_URL_DESC).defaultValue(this.getDeveloperOrganizationUrl()));
        ...
        cliOptions.add(CliOption.newBoolean(CodegenConstants.SERIALIZABLE_MODEL,
                CodegenConstants.SERIALIZABLE_MODEL_DESC, this.getSerializableModel()));
        cliOptions.add(CliOption.newBoolean(CodegenConstants.SERIALIZE_BIG_DECIMAL_AS_STRING,
                CodegenConstants.SERIALIZE_BIG_DECIMAL_AS_STRING_DESC, serializeBigDecimalAsString));
        cliOptions.add(CliOption.newBoolean(DISCRIMINATOR_CASE_SENSITIVE,
        ...
        cliOptions.add(CliOption.newBoolean(CodegenConstants.HIDE_GENERATION_TIMESTAMP,
                CodegenConstants.HIDE_GENERATION_TIMESTAMP_DESC, this.isHideGenerationTimestamp()));
        ...
        cliOptions.add(CliOption.newBoolean(USE_ONE_OF_INTERFACES,
        ...
        cliOptions.add(CliOption.newBoolean(DISABLE_HTML_ESCAPING,
                ...
                disableHtmlEscaping));
        cliOptions.add(CliOption.newString(BOOLEAN_GETTER_PREFIX, "Set booleanGetterPrefix")
        ...
        cliOptions.add(CliOption.newString(ADDITIONAL_ENUM_TYPE_ANNOTATIONS,
        ...
        cliOptions.add(CliOption.newString(ADDITIONAL_ONE_OF_TYPE_ANNOTATIONS,
        ...
        cliOptions.add(CliOption.newBoolean(OPENAPI_NULLABLE,
                "Enable OpenAPI Jackson Nullable library. Not supported by `microprofile` library.",
        ...
        cliOptions.add(CliOption.newBoolean(IMPLICIT_HEADERS,
                ...
                implicitHeaders));
        cliOptions.add(CliOption.newString(IMPLICIT_HEADERS_REGEX,
        ...
        cliOptions.add(CliOption.newBoolean(CAMEL_CASE_DOLLAR_SIGN,
        ...
        cliOptions.add(
                CliOption.newBoolean(CONTAINER_DEFAULT_TO_NULL, "Set containers (array, set, map) default to null"));
        cliOptions.add(CliOption
                .newBoolean(GENERATE_CONSTRUCTOR_WITH_ALL_ARGS, "whether to generate a constructor for all arguments")
                .defaultValue(Boolean.FALSE.toString()));
        cliOptions.add(CliOption.newBoolean(GENERATE_BUILDERS, "Whether to generate builders for models")
                .defaultValue(Boolean.FALSE.toString()));

        cliOptions.add(CliOption.newString(CodegenConstants.PARENT_GROUP_ID, CodegenConstants.PARENT_GROUP_ID_DESC));
        cliOptions.add(
                CliOption.newString(CodegenConstants.PARENT_ARTIFACT_ID, CodegenConstants.PARENT_ARTIFACT_ID_DESC));
        cliOptions.add(CliOption.newString(CodegenConstants.PARENT_VERSION, CodegenConstants.PARENT_VERSION_DESC));
        CliOption snapShotVersion = CliOption.newString(CodegenConstants.SNAPSHOT_VERSION,
                CodegenConstants.SNAPSHOT_VERSION_DESC);
        ...
        if (null != defaultDocumentationProvider()) {
            ...
            supportedDocumentationProvider()
                    .forEach(dp -> documentationProviderCliOption.addEnum(dp.toCliOptValue(), dp.getDescription()));
            ...
            supportedAnnotationLibraries()
                    .forEach(al -> annotationLibraryCliOption.addEnum(al.toCliOptValue(), al.getDescription()));
    ...
    public void processOpts() {
        ...
        convertPropertyToBooleanAndWriteBack(GENERATE_CONSTRUCTOR_WITH_ALL_ARGS,
                this::setGenerateConstructorWithAllArgs);
        ...
        if (StringUtils.isEmpty(System.getenv("JAVA_POST_PROCESS_FILE"))) {
            ...
            LOGGER.info(
                    "Warning: Environment variable 'JAVA_POST_PROCESS_FILE' is set but file post-processing is not enabled. To enable file post-processing, 'enablePostProcessFile' must be set to `true` (--enable-post-process-file for CLI).");
        }
        ...
        convertPropertyToStringAndWriteBack(CodegenConstants.DEVELOPER_ORGANIZATION_URL,
                this::setDeveloperOrganizationUrl);
        ...
        convertPropertyToBooleanAndWriteBack(CodegenConstants.SERIALIZE_BIG_DECIMAL_AS_STRING,
                this::setSerializeBigDecimalAsString);
        // need to put back serializableModel (boolean) into additionalProperties as
        // value in additionalProperties is string
        // additionalProperties.put(CodegenConstants.SERIALIZABLE_MODEL,
        // serializableModel);

        // By default, the discriminator lookup should be case sensitive. There is
        // nothing in the OpenAPI specification
        // that indicates the lookup should be case insensitive. However, some
        ...
        if (!StringUtils.isEmpty(parentGroupId) && !StringUtils.isEmpty(parentArtifactId)
    ...
    public Map<String, ModelsMap> postProcessAllModels(Map<String, ModelsMap> objs) {
         ...
         * ps: This code was specific to SpringCodeGen and now is available to all java
         * generators.
         */
        ...
        if (isGenerateConstructorWithAllArgs()) {
            ...
            for (CodegenModel cm : allModels.values()) {
                if (isConstructorWithAllArgsAllowed(cm)) {
                    ...
                    // vendorExtensions.x-java-all-args-constructor-vars should be equivalent to
                    // allVars
                    // but it is not reliable when
                    // openapiNormalizer.REFACTOR_ALLOF_WITH_PROPERTIES_ONLY is disabled
                    ...
                    if (cm.vars.size() + cm.parentVars.size() != cm.allVars.size()) {
                        once(LOGGER).warn("Unexpected allVars for {} expecting:{} vars. actual:{} vars", cm.name,
                                cm.vars.size() + cm.parentVars.size(), cm.allVars.size());
                    }
    ...
    protected boolean isConstructorWithAllArgsAllowed(CodegenModel codegenModel) {
        // implementation detail: allVars is not reliable if
        // openapiNormalizer.REFACTOR_ALLOF_WITH_PROPERTIES_ONLY is disabled
    ...
    public String apiTestFileFolder() {
        return (outputTestFolder + File.separator + testFolder + File.separator
                + apiPackage().replace('.', File.separatorChar)).replace('/', File.separatorChar);
    }
    ...
    public String toModelName(final String name) {
        ...
        // We need to check if schema-mapping has a different model for this class, so
        // we use it
    ...
    private String getTypeDeclarationForArray(Schema<?> items) {
        ...
        int idx = idxLt < 0 ? typeDeclaration.lastIndexOf('.') :
        // last dot before the generic like in
        // List<com.mycompany.Container<java.lang.Object>
     ...
     * Return empty if there's no bean validation for requested type or prop
     * useBeanValidation false or missed.
     *
     * @param items type
    ...
    private String getNumberBeanValidation(Schema<?> items) {
        if (items.getMinimum() != null && items.getMaximum() != null) {
            return String.format(Locale.ROOT,
                    "@DecimalMin(value = \"%s\", inclusive = %s) @DecimalMax(value = \"%s\", inclusive = %s)",
                    items.getMinimum(),
    ...
    private String getStringBeanValidation(Schema<?> items) {
        ...
        if (items.getMinLength() != null && items.getMaxLength() != null) {
            return String.join("",
                    validations,
                    String.format(Locale.ROOT, "@Size(min = %d, max = %d)", items.getMinLength(),
                            items.getMaxLength()));
        }
    ...
    public String toDefaultValue(CodegenProperty cp, Schema schema) {
        ...
        if (ModelUtils.isArraySchema(schema)) {
            if (defaultToEmptyContainer) {
                // if default to empty container option is set, respect the default values
            ...
            if (schema.getDefault() != null) {
                try {
                    ...
                    if (propertySchemas != null) {
                        // With `parseOptions.setResolve(true)`, objects with 1 key-value pair are
                        // LinkedHashMap and objects with more than 1 are ObjectNode
                        ...
                        for (Map.Entry<String, JsonNode> defaultProperty : defaultProperties) {
                            ...
                            if (ModelUtils.isLongSchema(propertySchema)) {
                                ...
                                if ("java8".equals(getDateLibrary())) {
                                    defaultPropertyExpression = String.format(Locale.ROOT,
                                            "java.time.LocalDate.parse(\"%s\")", value.asText());
                                }
                            } else if (ModelUtils.isDateTimeSchema(propertySchema)) {
                                if ("java8".equals(getDateLibrary())) {
                                    defaultPropertyExpression = String.format(Locale.ROOT,
                                            "java.time.OffsetDateTime.parse(\"%s\", %s)",
                                            value.asText(),
                                            "java.time.format.DateTimeFormatter.ISO_ZONED_DATE_TIME.withZone(java.time.ZoneId.systemDefault())");
                                }
    ...
    private String getDefaultCollectionType(Schema schema, String defaultValues) {
        ...
        if (defaultValues == null || defaultValues.isEmpty()) {
            ...
            // to respect default values provided in the spec, set the option
            // `defaultToEmptyContainer` properly
            defaultValues = "";
            arrayFormat = "new %s<>()";
        }
    ...
    private String getDefaultCollectionType(String arrayFormat, String defaultValues, boolean isSet) {
        ...
        return String.format(Locale.ROOT, arrayFormat, instantiationTypes().getOrDefault("array", "ArrayList"),
                defaultValues);
    }

    @Override
    public String toDefaultParameterValue(final Schema<?> schema) {
        Object defaultValue = schema.get$ref() != null ? ModelUtils.getReferencedSchema(openAPI, schema).getDefault()
                : schema.getDefault();
        ...
        if (ModelUtils.isArraySchema(schema)) {
            // swagger-parser parses the default value differently depending on whether it's
            // in a referenced file or not.
    ...
    /**
     * Return the example value of the parameter. Overrides the parent method in
     * DefaultCodegen
    ...
    public void setParameterExampleValue(CodegenParameter codegenParameter, RequestBody requestBody) {
        boolean isModel = (codegenParameter.isModel
    ...
    public String toOperationId(String operationId) {
        ...
        if (operationId.matches("^\\d.*")) {
            LOGGER.warn(operationId + " (starting with a number) cannot be used as method name. Renamed to "
                    + camelize("call_" + operationId), true);
    ...
    public void postProcessModelProperty(CodegenModel model, CodegenProperty property) {
        ...
        // hard-coded Arrays import in Java client as it has been removed from the
        // templates
        ...
        if ("array".equals(property.containerType)) {
            ...
            if ((!openApiNullable || !property.isNullable) && jackson) { // cannot be wrapped to nullable
                ...
                property.vendorExtensions.put("x-setter-extra-annotation",
        ...
        if (property.vendorExtensions.containsKey("x-expandable")) {
            ...
            if (expandableType != null && !expandableType.trim().isEmpty()) {
                ...
                if (property.isContainer && "array".equals(property.containerType)) {
                    ...
                    LOGGER.debug(
                            "Array property '{}' transformed to List<ExpandableField<{}>> due to x-expandable extension",
        ...
        // if data type happens to be the same as the property name and both are upper
        // case
        if (property.dataType != null && property.dataType.equals(property.name)
     ...
     * <li>{@code List<@Pattern(regexp = "^[a-z]$")String>}" ->
     * "{@code List<String>}"</li>
     ...
     * It will also first use {{@link #removeAnnotations(String)}} to remove the
     * annotations added to the datatype
     * 
     * @param dataType the data type string
     * @return the data type string without annotations and any characters except
     *         alphanumeric ones
     */
    ...
    public void preprocessOpenAPI(OpenAPI openAPI) {
            ...
            for (Map.Entry<String, PathItem> openAPIGetPathsEntry : openAPI.getPaths().entrySet()) {
                ...
                for (Operation operation : path.readOperations()) {
                    ...
                    if (hasBodyParameter(operation) || hasFormParameter(operation)) {
                        String defaultContentType = hasFormParameter(operation) ? "application/x-www-form-urlencoded"
                                : "application/json";
        ...
        // TODO: Setting additionalProperties is not the responsibility of this method.
        // These side-effects should be moved elsewhere to prevent unexpected behaviors.
        ...
        switch (getEnumPropertyNaming()) {
            ...
            case original:
                ...
                if (isValidVariableNameInVersion(value, SourceVersion.RELEASE_11)) {
                    ...
                    LOGGER.warn("Enum value '{}' is not a valid variable name in Java 11. Enum value will be renamed.",
                            value);
                    var = value;
                }
                break;
    ...
    public String getterAndSetterCapitalize(String name) {
        ...
        // except when the first letter of the property name is lowercase and the second
        // letter is uppercase
        // Refer to section 8.8: Capitalization of inferred names of the JavaBeans API
        // specification
    ...
    protected void addAdditionPropertiesToCodeGenModel(CodegenModel codegenModel, Schema schema) {
        ...
        // See
        // https://github.com/OpenAPITools/openapi-generator/pull/1729#issuecomment-449937728
     ...
     * @return either found property or {@link Optional#empty()} if nothing has been
     *         found
     */
    ...
    /**
     * This method removes all implicit header parameters from the list of
     * parameters
     *
    ...
    protected void handleImplicitHeaders(CodegenOperation operation) {
        ...
        for (CodegenParameter p : copy) {
            if (p.isHeaderParam && (implicitHeaders || shouldBeImplicitHeader(p))) {
                ...
                LOGGER.info("Update operation [{}]. Remove header [{}] because it's marked to be implicit",
                        operation.operationId, p.baseName);
            } else {
    ...
    public List<VendorExtension> getSupportedVendorExtensions() {
        ...
        extensions.add(VendorExtension.X_EXPANDABLE);
        return extensions;
    }
    ...
    public static void addImports(List<Map<String, String>> imports, CodegenModel cm,
     ...
     *
     * @param enumPropertyNamingType The string representation of the naming
     *                               convention, as defined by
     *                               {@link ENUM_PROPERTY_NAMING_TYPE}
     */
    public void setEnumPropertyNaming(final String enumPropertyNamingType) {
        try {
            ...
            StringBuilder sb = new StringBuilder(
                    enumPropertyNamingType + " is an invalid enum property naming option. Please choose from:");
